...
contract AstarCats is ERC721Enumerable, Ownable {
    ...
    function preMint(uint256 _mintAmount) public payable {
        ...
        require(whiteLists[msg.sender] >= _mintAmount, "CL: Five cats max per address in Catlist");
    ...
    function mintCheck(
        ...
        require(supply + _mintAmount <= maxSupply, "Total supply cannot exceed maxSupply");
